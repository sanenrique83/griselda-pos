...
- Header A con saludo personalizado, 3 accesos rápidos, Panel del turno (5 métricas, íconos con tinte verde bosque, `flex-wrap` verificado a ~375-390px), toggle Mapa/Lista (ícono `LayoutGrid`, igual al bottom nav), leyenda de 5 colores restyled (chips, sin cambiar estados).
